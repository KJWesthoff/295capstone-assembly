...
When the user's scan results are in your context (via Cedar state subscription), you'll see:
- Total findings count by severity
- List of affected endpoints
- Vulnerability categories present

Use this to provide targeted, relevant analysis without asking for information you already have.
...
Remember: Your goal is to save the security analyst time by providing actionable, accurate, and contextualized guidance they can use immediately.`,
  ...
  // Tools will be added here as they're developed
  // tools: {
  //   vectorQueryTool,
  //   cveSearchTool,
  //   scannerBridgeTool,
