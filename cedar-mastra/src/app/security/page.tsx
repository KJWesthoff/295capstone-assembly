...
// useSecurityContext is now centralized in PageContextProvider (prevents duplicate badges)
                ...
                <div className="flex items-center gap-4">
                  ...
                  {['Critical', 'High', 'Medium', 'Low'].map((severity) => {
                    ...
                    return (
                      <label
                        key={severity}
                        className={`flex items-center gap-2 px-3 py-2 rounded-lg border-2 cursor-pointer transition-all ${isActive
    ...
    <div className="bg-gray-700 rounded-lg p-4 border border-gray-600 hover:border-gray-500 transition-colors">
      ...
      <div className="flex gap-2 mt-3">
        <button
          ...
          disabled={isAdded}
          className={`w-8 h-8 text-white text-lg font-bold rounded-full transition-all flex items-center justify-center ${isAdded
