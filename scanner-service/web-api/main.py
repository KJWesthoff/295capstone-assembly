...
def generate_html_report(findings: List[Dict], output_dir: Path):
    """Generate HTML report from findings"""
    html = f"""<!DOCTYPE html>
<html>
<head>
    <title>VentiAPI Scanner Report</title>
    <style>
        body {{ font-family: Arial, sans-serif; margin: 20px; }}
        .header {{ background: #f8f9fa; padding: 20px; border-radius: 5px; margin-bottom: 20px; }}
        .finding {{ border: 1px solid #ddd; margin: 10px 0; padding: 15px; border-radius: 5px; }}
        .severity {{ padding: 3px 8px; border-radius: 3px; color: white; font-weight: bold; }}
        .endpoint {{ font-family: monospace; background: #f1f1f1; padding: 2px 4px; border-radius: 3px; }}
...
<body>
    <div class="header">
        <h1>🔍 VentiAPI Security Scan Report</h1>
    ...
    <div class="summary">
        ...
        <p><strong>Low:</strong> {len([f for f in findings if f.get('severity') == 'Low'])}</p>
    </div>
...
"""
    ...
    for i, finding in enumerate(findings):
        ...
        severity_class = severity.lower() if severity != 'Unknown' else 'low'
        html += f"""
    <div class="finding">
        <h3>
        ...
        <p><strong>Endpoint:</strong> <span class="endpoint">{finding.get('method', 'GET')} {finding.get('endpoint', 'Unknown')}</span></p>
        <p><strong>Rule:</strong> {finding.get('rule', 'N/A')}</p>
        <p><strong>Score:</strong> {finding.get('score', 'N/A')}</p>
        <p><strong>Description:</strong> {finding.get('description', 'No description available')}</p>
    </div>
"""
    
    html += """
    <footer style="margin-top: 40px; padding: 20px; background: #f8f9fa; text-align: center; border-radius: 5px;">
        <p>Generated by <strong>VentiAPI Scanner</strong> - API Security Testing Tool</p>
    </footer>
</body>
</html>
"""
...
def merge_scan_findings(scan_id: str, num_chunks: int) -> Dict:
    ...
    generate_html_report(merged_findings, main_results_dir)
